...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        if self.game_state == game_state.GameState.ROUND_DONE:
            ...
            if self.winner == "win":
                arcade.draw_text("gagné ;)", start_x=80, start_y=700, font_size=30,color=arcade.color.BABY_POWDER)
            if self.winner == "loss":
                arcade.draw_text("perdu;)", start_x=80, start_y=700, font_size=30,color=arcade.color.BABY_POWDER)
            if self.winner == "draw":
                arcade.draw_text("egal;)", start_x=80, start_y=700, font_size=30,color=arcade.color.BABY_POWDER)
